  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        heat: {
          "up-strong": "hsl(var(--heat-up-strong))",
          "up-mild": "hsl(var(--heat-up-mild))",
          "down-mild": "hsl(var(--heat-down-mild))",
          "down-strong": "hsl(var(--heat-down-strong))",
          empty: "hsl(var(--heat-empty))",
        },
        sidebar: {
